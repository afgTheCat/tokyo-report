...
My main field of interest is probability theory. As the theoretical foundation for reinforcement learning is the Markov decision process I have also spent considerable time learning about the subject. As I do not consider it to be a subfield of probability theory, I will write about them separately.
...
Writing this section was largely inspired by \cite{LMCJ}. The above figures can be seen as an independent verification of their computations.
